...
function StatusRow({ label, ready }: { label: string; ready: boolean }) {
  return (
    ...
    >
      <div style={{ color: "#c8e8ff", fontSize: 13, fontWeight: 600 }}>{label}</div>
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        {ready ? (
          <>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <circle cx="8" cy="8" r="7" stroke="#00ff88" strokeWidth="1.5" />
              <path d="M5 8.5l2 2 4-4" stroke="#00ff88" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
            <span style={{ color: "#00ff88", fontSize: 11, letterSpacing: "0.1em" }}>READY</span>
          </>
        ) : (
          <>
            <Spinner />
            <span style={{ color: "#00aaff", fontSize: 11, letterSpacing: "0.1em" }}>LOADING</span>
          </>
        )}
      </div>
    </div>
...
function Spinner() {
  return (
    ...
    >
      ...
      <circle cx="8" cy="8" r="6" stroke="rgba(0,136,255,0.25)" strokeWidth="2" />
      <path d="M8 2a6 6 0 0 1 6 6" stroke="#00aaff" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
